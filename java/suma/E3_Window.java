 ...
 * @author HP
 */
public class E3_Window extends javax.swing.JFrame {

    /**
     * Creates new form E3_Window
     */
    public E3_Window() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtn1)
                    .addComponent(txtresultado, javax.swing.GroupLayout.DEFAULT_SIZE, 149, Short.MAX_VALUE))
    ...
    private void txtcalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtcalcularActionPerformed
        ...
        n1 = Integer.parseInt(txtn1.getText());
         ...
         if(n1 % 2 == 0) {
         txtresultado.setText(String.valueOf("Es Par"));
     }
     else{
         txtresultado.setText(String.valueOf("Es Impar"));
     } 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(E3_Window.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
